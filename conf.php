...
$CONF = array(
  ...
  'BBSTITLE' => 'StrangeWorld@',           # * Bulletin board name
  ...
  'ADMINMAIL' => '',                # * Administrator email address
  ...
  'META_DESCRIPTION' => 'This is the "StrangeWorld@" bulletin board.',
  ...
  'META_KEYWORDS' => 'AyashiiWorld,AyaWa,StrangeWorld,Ayashii,ᵃʸᵃˢʰⁱⁱ,strange',
...
#  'TMPL_ENVLIST' => "<div class=\"env\">{val envaddr}{val envbr}{val envua}</div>\n",
  ...
  'viagra','Viagra','a href=','casino','Casino','スーパーコピー'
  ),
